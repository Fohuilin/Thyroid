...
def nri_cal(df,n):
    ...
    p_value_nri_ev ="%.10f" % (2*norm.cdf(-abs(z_nri_ev)))
    ...
    p_value_nri_ne ="%.10f" % (2*norm.cdf(-abs(z_nri_ne)))
    ...
    p_value_nri ="%.10f" % (2*norm.cdf(-abs(z_nri)))
    ...
    p_value_idi = "%.10f" % (2*norm.cdf(-abs(z_idi)))
